    ...
    <>
      <div className="mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-24 lg:grid lg:max-w-7xl lg:grid-cols-2 lg:gap-x-8 lg:px-8">
        <div className="lg:max-w-lg lg:self-end">
          ...
          <section className="mt-4">
            <div className="flex items-center">
              ...
              <div className="ml-4 border-l text-muted-foreground border-gray-300 dark:border-zinc-700 pl-4">
                {reward?.type}
              </div>
            </div>
        ...
        <div className="mt-10 lg:col-start-2 lg:row-span-2 lg:mt-0 lg:self-center">
          <div className="aspect-square rounded-lg bg-gray-100 dark:bg-zinc-900 overflow-hidden flex items-center justify-center w-full">
            {urls.length > 0 ? (
          ...
          <div>
            ...
            {result && result.success ? (
              <div className="mt-4 rounded-md border p-4 text-sm">
                ...
                {resolved?.ok && resolved.type === "fetch" && (
                  <div className="text-muted-foreground">Fetch processed.</div>
                )}
              </div>
            ) : null}
            <div className="mt-6 text-center">
              <div className="group inline-flex text-sm text-medium">
                ...
                />
                <span className="text-muted-foreground hover:text-gray-700  dark:hover:text-gray-300">
