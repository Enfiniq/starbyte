...
function ResetPasswordContent() {
  ...
  return (
    <div className="min-h-[80vh] w-screen flex justify-center items-center px-4">
      <div className="w-full max-w-2xl mx-auto">
        <div className="flex flex-col items-center text-center space-y-4 mb-6">
          <Image
            src="/brands/starbyte.svg"
            alt="Starbyte"
            width={36}
            height={36}
          />
          ...
          >
            <div className="space-y-1">
              ...
              <PasswordToggle
                ...
                className="rounded"
                icon={
                  <MdOutlineLock className="icon text-gray-600 dark:text-gray-300" />
                }
              />
            </div>
            <div className="space-y-1">
